...
private val ANDROID_SUPPORTED_NON_NAVIDROME_IMPORT_AUDIO_EXTENSIONS = setOf(
    "mp3",
    "m4a",
    "aac",
    "wav",
...
internal fun classifyAndroidScannedAudioFile(fileName: String): NonNavidromeAudioScanResult {
    return classifyNonNavidromeAudioFile(
        fileName = fileName,
        supportedImportExtensions = ANDROID_SUPPORTED_NON_NAVIDROME_IMPORT_AUDIO_EXTENSIONS,
    )
}
